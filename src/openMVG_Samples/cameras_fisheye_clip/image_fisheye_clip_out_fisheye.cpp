...
int main(int argc, char **argv) {
  ...
  for (size_t j = 0; j < vec_fileNames.size(); ++j, ++my_progress_bar) {
    ...
    const Pinhole_Intrinsic_Fisheye pinhole_cam(300.0, 300.0, 250.0, 300.0/2.0, 300.0/2.0, 0.0, 0.0,
                                                0.0, 0.0);
    ...
    // auto rot = RotationAroundY(45.0); // for left fisheye
    auto rot = RotationAroundY(-45.0); // for right fisheye
